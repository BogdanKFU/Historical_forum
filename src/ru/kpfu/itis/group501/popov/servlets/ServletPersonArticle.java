...
public class ServletPersonArticle extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List list = CustomRepository.getBy(PersonArticle.class, "id", id);
        CustomStatement cs = new CustomStatement();
        Map map = CustomRepository.do_sql(cs.select(PersonComment.class).joinBy(User.class, "persons_article", id));
        if (!list.isEmpty()) {
